...
print("dynamic equation with motor dynemics:")
print(eqn)

D_error=sym.simplify(D_calculator(l2*1.2))
eqn1=dynamical_equation(D_error)
print("feed forward equation cancelling motor dynamics and D matrix of dynamic equation:")
...
with open('data\\4d1.pkl', 'wb') as file:
