...
while(ode_eqn.t<6):
    ...
    feed=feed_eqn.subs([('q1_dot_dot',q1_dot_dot_d),('q2_dot_dot',q2_dot_dot_d),('q3_dot_dot',d3_dot_dot_d), ('q1_dot',q1_dot_d),('q2_dot',q2_dot_d),('q3_dot',d3_dot_d), ('q1',q1_d),('q2',q2_d),('q3',d3_d)])
    
    v1 = feed[0][0] + kp*(q1_d-q1) + kd*(q1_dot_d-q1_dot)
    v2 = feed[1][0] + kp*(q2_d-q2) + kd*(q2_dot_d-q2_dot)
    v3 = feed[2][0] + kp*(d3_d-d3) + kd*(d3_dot_d-d3_dot)
...
with open('data\\5b1.pkl', 'wb') as file:
